...
// test('current task is being edited', () => {
//     const taskData: TaskV2SetV2 = {
//         ...defaultTaskV2SetV2Data,
//         0: {
//             ...defaultTaskV2SetV2Data[0],
...
//     expect(screen.getByDisplayValue('two')).toHaveClass('focus-task')
//     expect(screen.getByDisplayValue('two')).toHaveClass('focus-current-task')
// })
